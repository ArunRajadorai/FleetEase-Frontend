...
function VehicleShowcase3(props) {
  ...
  // Ensure lightboxImages is an array of URLs
  const images = Array.isArray(props.lightboxImages) ? props.lightboxImages : [];
  ...
  return (
    <>
        ...
        <div className="car-details">
          <div className="car-content">
            ...
            <div className="car-attribute-columns">
              {props.attri && props.attri.map((val, index) => (
      ...
      {isOpen && (
        <Lightbox
          imagePadding={50}
          mainSrc={images[photoIndex]} // Ensure this is a URL string
          imageTitle={props.carName}
